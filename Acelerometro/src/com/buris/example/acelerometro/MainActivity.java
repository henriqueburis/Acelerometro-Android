...
public class MainActivity extends Activity implements SensorEventListener {
	...
	public void onSensorChanged(SensorEvent arg0) {
		 ...
		 * for 0 então o celular ta em pé - Nem Direita Nem Esquerda Se o valor
		 * de Y for 0 então o cel ta "deitado" Se o valor de Y for negativo
		 * então ta de cabeça pra baixo, então quanto menor y mais ele ta
		 * inclinando pra ir pra baixo Se o valor de Z for 0 então o dispositivo
